...
#     @mining_block : Block?
#
#     def initialize(@wallet : Wallet, @database : Database?)
#       initialize_dapps
#
...
#       info "start loading fastchain from #{database.path}"
#       info "there are #{database.max_index} fast blocks recorded"
#
#       current_index = 0_i64
#       loop do
